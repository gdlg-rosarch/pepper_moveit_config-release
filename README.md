## pepper_moveit_config (kinetic) - 0.0.8-0

The packages in the `pepper_moveit_config` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release pepper_moveit_config -t kinetic -r kinetic` on `Wed, 18 Jan 2017 11:03:46 -0000`
...
## pepper_moveit_config (jade) - 0.0.8-0

The packages in the `pepper_moveit_config` repository were released into the `jade` distro by running `/usr/bin/bloom-release pepper_moveit_config -t jade -r jade` on `Wed, 18 Jan 2017 11:00:18 -0000`
...
## pepper_moveit_config (indigo) - 0.0.8-0

The packages in the `pepper_moveit_config` repository were released into the `indigo` distro by running `/usr/bin/bloom-release pepper_moveit_config -t indigo -r indigo` on `Wed, 18 Jan 2017 10:56:50 -0000`
...
## pepper_moveit_config (kinetic) - 0.0.7-0

The packages in the `pepper_moveit_config` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release pepper_moveit_config -t kinetic -r kinetic --new-track` on `Wed, 18 Jan 2017 10:46:11 -0000`
...
## pepper_moveit_config (indigo) - 0.0.6-0

The packages in the `pepper_moveit_config` repository were released into the `indigo` distro by running `/usr/bin/bloom-release pepper_moveit_config --track indigo --rosdistro indigo` on `Mon, 19 Sep 2016 20:06:15 -0000`
...
## pepper_moveit_config (jade) - 0.0.6-0

The packages in the `pepper_moveit_config` repository were released into the `jade` distro by running `/usr/bin/bloom-release pepper_moveit_config --track jade --rosdistro jade --new-track` on `Sun, 18 Sep 2016 16:21:31 -0000`
...
## pepper_moveit_config (indigo) - 0.0.4-2
